...
export const categories = [
  { id: "cat-hampers", name: "Signature Hampers" },
  { id: "cat-floral", name: "Floral Collections" },
  { id: "cat-gourmet", name: "Gourmet Gifts" },
  { id: "cat-festive", name: "Festive Editions" },
];

export const subCategories = [
  { id: "sub-luxe", categoryId: "cat-hampers", name: "Luxe Tray Boxes" },
  { id: "sub-classic", categoryId: "cat-hampers", name: "Classic Basket Sets" },
  { id: "sub-roses", categoryId: "cat-floral", name: "Rose Arrangements" },
  { id: "sub-purple", categoryId: "cat-floral", name: "Orchid & Purple Blooms" },
  { id: "sub-artisan", categoryId: "cat-gourmet", name: "Artisan Treats" },
  { id: "sub-coffee", categoryId: "cat-gourmet", name: "Coffee & Cocoa Pairings" },
  { id: "sub-diwali", categoryId: "cat-festive", name: "Diwali Premiums" },
  { id: "sub-yearend", categoryId: "cat-festive", name: "Year-End Celebrations" },
];
